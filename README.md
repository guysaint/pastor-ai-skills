...
원저자에게 감사합니다.
> 원본에 없는 "설교 원고 다듬기(/sermon-polish)"를 추가했습니다.
> 이 스킬은 원저자 Thomas Costello가 제공하는 "77 AI Prompts Every Pastor Needs(목사를 위한 77가지 AI 프롬프트)"를 참고하여 만들었습니다.
26.05.26 말씀 묵상의 관찰/해석 스킬을 자체 제작하여 추가했습니다.(/passage)
---
...
| `/passage` 🇰🇷 | 개인 묵상용 본문 관찰·해석: 관찰, 역사·주석·성경 내적 해석, 묵상 시작점 질문. 마크다운 출력. | 매일 |
